...
<head>
    ...
    <style>
        ...
        .kotak2 {
            width: 500px;
            height: 650px;
            background-color: rgb(213, 243, 17);
            border-radius: 5px;
            margin-top: 20px;
            padding: 20px;
        }
        .kotak3 {
            ...
            margin: 0 auto;
            display: grid;
            background-color: rgb(11, 239, 45);
            padding: 10px;
            border-radius: 5px;
        }
        .row {
...
<body>
    <div class="kotak1">
        <div class="kotak2">
            <center>
                <img src="gambar/download2.png  " width="90" alt="logo">
            </center>
            <div class="kotak3">
                <center><h2>Aplikasi Menghitung Diskon G.co</h2></center>
